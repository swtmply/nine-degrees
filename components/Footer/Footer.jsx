...
export default function Footer() {
  return (
    <div className="col-span-full min-h-[750px] max-h-[750px] bg-slate-200 relative bg-[url('/assets/Footer.png')] bg-[length:100vw_100%] bg-center bg-no-repeat flex flex-col py-4 justify-center items-center">
      ...
      <div className="flex w-[80%] justify-between text-white mt-10">
          ...
          <div key={idx}>
            ...
            <div>
              {category?.subsection?.map((subsection, idx) => (
                <div key={idx}>
                  <Link href={`/${category.value}/${subsection.value}`}>
